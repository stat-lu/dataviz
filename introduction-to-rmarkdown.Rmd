...
The benefit of using R Markdown is that you can choose the kind of output you
want. R Markdown documents can be turned into PDFs, Word Documents, and HTML
pages (and much more) with only a few small changes to the document.
...
```markdown
![A caption (<https://xkcd.com/1945/>).](images/xkcd.png){width=250px}
```

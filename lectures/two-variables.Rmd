...
It is straightforward when both variables are continuous.
...
It is often useful to combine points and lines when measurements are taken at irregular intervals or infrequently.
...
Categorical variables (factors) can be used as the second dimension.
...
A simple solution: **opacity** (`alpha`)
...
Pairs plot plots the pairwise associations of several variables.

It is complicated in ggplot2 (requires **pivoting** and **facets**).

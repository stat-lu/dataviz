...
If you want to go down this road, start by downloading the submission template
that we have provided for you by running the following code,

```{r eval = FALSE}
download.file(
  "https://raw.githubusercontent.com/stat-lu/dataviz/main/template.Rmd",
  "template.Rmd", # filename for the file (which you can replace)
  mode = "wb"
)
```
